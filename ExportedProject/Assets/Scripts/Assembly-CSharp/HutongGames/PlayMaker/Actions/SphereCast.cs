...
{
	[Tooltip("Casts a Sphere against all Colliders in the scene.")]
	...
	public class SphereCast : FsmStateAction
	{
		...
		private void DoRaycast()
		{
			...
			if (distance.Value != 0f)
			{
				...
				RaycastHit hitInfo;
				Physics.SphereCast(vector, radius, vector2, out hitInfo, num, ActionHelpers.LayerArrayToLayerMask(layerMask, invertMask.Value));
