	...
	public class SetHandsPosition : FsmStateAction
	{
		...
		private void DoCalc()
		{
			...
			if (Hand01Obj != null)
			{
				...
				Collider component = ownerDefaultTarget.transform.GetComponent<Collider>();
				RaycastHit hitInfo;
				if (component.Raycast(ray, out hitInfo, 100f))
				{
			...
			if (Hand02Obj != null)
			{
				...
				Collider component2 = ownerDefaultTarget.transform.GetComponent<Collider>();
				RaycastHit hitInfo2;
				if (component2.Raycast(ray2, out hitInfo2, 100f))
				{
