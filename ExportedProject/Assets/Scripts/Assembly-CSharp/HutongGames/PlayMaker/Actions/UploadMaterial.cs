...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Saves a Material to MySQL Server via ES2.php file. See moodkie.com/easysave/WebSetup.php for how to set up MySQL.")]
	public class UploadMaterial : FsmStateAction
	{
		[RequiredField]
		...
		public override void OnEnter()
		{
			...
			base.Fsm.Owner.StartCoroutine(web.Upload(saveValue.Value as Material));
