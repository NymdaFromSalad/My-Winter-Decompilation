...
{
	[Tooltip("Loads a previously saved Material.")]
	[ActionCategory("Easy Save 2")]
	public class LoadMaterial : FsmStateAction
	{
		...
		public override void OnEnter()
		{
			...
			loadValue.Value = ES2.Load<Material>(string.Concat(saveFile, "?tag=", uniqueTag), eS2Settings);
