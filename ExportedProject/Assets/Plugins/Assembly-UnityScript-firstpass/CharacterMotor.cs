...
{
	[Serializable]
	internal sealed class _0024SubtractNewPlatformVelocity_00245 : GenericGenerator<object>
	{
		[Serializable]
		internal sealed class _0024 : GenericGeneratorEnumerator<object>, IEnumerator
		{
			internal Transform _0024platform_00246;

			internal CharacterMotor _0024self__00247;
			...
			public override bool MoveNext()
			{
				...
				{
				default:
					if (_0024self__00247.movingPlatform.enabled && (_0024self__00247.movingPlatform.movementTransfer == MovementTransferOnJump.InitTransfer || _0024self__00247.movingPlatform.movementTransfer == MovementTransferOnJump.PermaTransfer))
					{
				...
				case 3:
					...
					goto case 4;
				case 4:
					_0024self__00247.movement.velocity = _0024self__00247.movement.velocity - _0024self__00247.movingPlatform.platformVelocity;
					goto IL_0124;
				case 1:
					{
						result = 0;
		...
		internal CharacterMotor _0024self__00248;

		public _0024SubtractNewPlatformVelocity_00245(CharacterMotor self_)
		{
			_0024self__00248 = self_;
		}

		public override IEnumerator<object> GetEnumerator()
		{
			return new _0024(_0024self__00248);
		}
	}
	...
	{
		return new _0024SubtractNewPlatformVelocity_00245(this).GetEnumerator();
	}
